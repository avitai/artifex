...
#### [`generative_models/protein/protein_diffusion_example.py`](generative_models/protein/protein_diffusion_example.py)
...
#### [`generative_models/protein/protein_extensions_with_config.py`](generative_models/protein/protein_extensions_with_config.py)

Configuration-driven protein modeling with extension system.

#### [`generative_models/protein/protein_ligand_benchmark_demo.py`](generative_models/protein/protein_ligand_benchmark_demo.py)

Benchmark demonstrations for protein-ligand interaction modeling.

#### [`generative_models/protein/protein_point_cloud_example.py`](generative_models/protein/protein_point_cloud_example.py)

Point cloud representations for protein structure modeling.

### Geometric Modeling

#### [`generative_models/geometric/geometric_benchmark_demo.py`](generative_models/geometric/geometric_benchmark_demo.py)

Comprehensive benchmark suite for geometric generative models.

#### [`generative_models/geometric/geometric_losses_demo.py`](generative_models/geometric/geometric_losses_demo.py)

Specialized loss functions for geometric data.

#### [`generative_models/geometric/geometric_models_demo.py`](generative_models/geometric/geometric_models_demo.py)

Various geometric model architectures and applications.

#### [`generative_models/geometric/simple_point_cloud_example.py`](generative_models/geometric/simple_point_cloud_example.py)

Basic point cloud generation and processing.

### Advanced Sampling

#### [`generative_models/sampling/blackjax_example.py`](generative_models/sampling/blackjax_example.py)
...
#### [`generative_models/energy/simple_ebm_example.py`](generative_models/energy/simple_ebm_example.py)
...
#### [`generative_models/diffusion/simple_diffusion_example.py`](generative_models/diffusion/simple_diffusion_example.py)

Basic diffusion model implementation and usage.

### VAE Models

#### [`generative_models/vae/multi_beta_vae_benchmark_demo.py`](generative_models/vae/multi_beta_vae_benchmark_demo.py)
...
- **Main Documentation**: See the main [README.md](../README.md)
