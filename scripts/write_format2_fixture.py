#!/usr/bin/env python3
"""Write the format-2 trainer fixture in an environment that neither floats nor drifts.

The fixture must be written by the releases that produced it (artifex 0.1.10 over substrax
...
PRODUCERS = ("avitai-artifex==0.1.10", "substrax==0.1.9")
LOCKED = ("jax", "jaxlib", "flax")
GENERATOR = Path("scripts") / "make_format2_trainer_fixture.py"
