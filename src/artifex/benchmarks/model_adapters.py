...
benchmark system. Adapters implement the ModelProtocol interface required by
benchmarks.
"""
...
from artifex.benchmarks.base import ModelProtocol
...
class BenchmarkModelAdapter(ModelProtocol, ABC):
    ...
    def __init__(self, model: Any) -> None:
        ...
        self._model_name = getattr(model, "model_name", "unknown")
